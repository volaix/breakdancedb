...
const makeString = (moveArray: string[]): string => {
      ...
      <article className="body-font mx-auto text-gray-400 md:w-2/3 lg:w-1/2">
        ...
        >
          ...
          <section className="relative w-full p-2">
            ...
            <p className="text-xs">
              {`calculated ${unsavedMoveList.split(/\r\n|\r|\n/).length} moves from above. New move created each line. Saved is ${lsMoves.split(/\r\n|\r|\n/).length} moves.`}
            </p>
            <Notification
            ...
            >
              <label className="text-xs leading-none">Sort list</label>
            </button>
          </section>
        </form>
        {/* ------------end of form----------- */}
