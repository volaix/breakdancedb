...
const FlowBox = ({flow}) => {
  ...
  return (
    <div class="p-2 w-1/3">
      <div class="h-full bg-gray-800 bg-opacity-40 px-3 pt-5 pb-6 rounded-lg overflow-hidden text-center relative flex flex-col">
        <h2 class="tracking-widest title-font font-medium text-gray-500 mb-1 text-[7px]">
          FLOWS
        </h2>
        <h1 class="title-font sm:text-2xl text-[9px] font-medium text-white mb-1">
        ...
        <p class="leading-relaxed  text-[6px]">
          Addon notes about this flow. Hands are nice.
        </p>
        <div className="flex justify-center mt-1">
          <a class="text-indigo-400 items-center  text-[6px]">
            Edit
            <svg
              class="w-2 h-2 ml-1 inline-flex "
              viewBox="0 0 24 24"
              stroke="currentColor"
              stroke-width="2"
              fill="none"
        ...
        <div class="text-center mt-2 leading-none flex justify-center absolute bottom-0 left-0 w-full py-1">
          <span class="text-gray-500 mr-1 inline-flex items-center leading-none text-[7px] pr-1 py-1 border-r-2 border-gray-700 border-opacity-50">
            <svg
              fill="currentColor"
              class="w-3 h-3 mr-1"
              viewBox="0 0 26 26"
          ...
          <span class="text-gray-500 inline-flex items-center leading-none text-[7px]">
            <svg
              x="0px"
              y="0px"
              fill="currentColor"
