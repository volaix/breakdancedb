 ...
 * @returns jsx
 */
export const RenderDownloadSvg = ({ ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
 ...
 * @returns jsx
 */
export const RenderSpinner = ({ ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
/**
 * renders svg icon dice
 * @returns jsx
 */
export const RenderDiceSvg = ({ ...props }: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlnsXlink="http://www.w3.org/1999/xlink"
    height="800px"
